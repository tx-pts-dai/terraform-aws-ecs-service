...
| <a name="input_extra_iam_policies"></a> [extra\_iam\_policies](#input\_extra\_iam\_policies) | List of IAM policy ARNs to be attached to the IAM role impersonated by the ECS Task | `list(string)` | `[]` | no |
