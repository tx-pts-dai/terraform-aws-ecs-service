...
| <a name="input_efs_volumes"></a> [efs\_volumes](#input\_efs\_volumes) | Map of EFS volumes to mount | <pre>map(object({<br>    fs_id           = string<br>    root            = string<br>    access_point_id = optional(string)<br>  }))</pre> | `{}` | no |
